...
Let's evaluate the products or services that market themselves as "good" for the environment and us!

- Choose something you are interested in and then spend time evaluating the claims

- Is there any evidence this is actually "good" for both us and the environment?
...
Canvas DISCUSSION: Reflecting on the Utility Narratives Around Us

Find a product or service that markets itself as "good" for the environment in line with the conservation and management arguments we explored last class. 

By "good" I mean something that improves our ability to extract value from the environment, or its resources, without causing serious harm or jeopardizing the long-term survival of that system.

Submit:

1) A link to the product or service,

2) an explanation of how this product claims to be "good" for the environment (2+ sentences), and

3) AT LEAST TWO pieces of external evidence evaluating these claims (can be either in support or opposition to them, 2+ sentences each). In other words, does this product or service "work" as promised?
