...
**SLIDE**: Let's go find current examples!
...
- Find us recent examples of green groups "mindbombing the wealthy"

::: notes

Everybody hit the internet for a minute and find us more recent examples of green groups active mindbombing campaigns
...
In chapter 11 Dauvergne argues that corporate partnerships with green NGOs represent the "forefront of the environmentalism of the rich"

- He gives us examples of the World Wildlife Federation, Coca cola and other corporate partnerships
...
- Class Side A: Make a list on the board of all the positive benefits of pursuing these kinds of deals

- Class Side B: Make a list on the board of all the costs from pursuing these kinds of deals

- Work directly on the board! Go!
...
## Due Next Tuesday (Nov 24th) {background-image="Images/background-forest_v3.png" .center}
